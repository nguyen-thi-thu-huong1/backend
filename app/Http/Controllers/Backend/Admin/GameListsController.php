...
{
    protected $create_field = ['publisher_id','api_name','name','en_name','game_type','game_code','tcg_game_type','param_remark','img_path','img_url','client_type','platform','is_open','weight','tags'];
    protected $update_field = ['publisher_id','api_name','name','en_name','game_type','game_code','tcg_game_type','param_remark','img_path','img_url','client_type','platform','is_open','weight','tags'];
