            ...
            <div class="card-body text-center">
                ...
                <form method="post" class="form-horizontal"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <h4 class="text-danger" style="background: #fcfc35;">{{ number_format($model->money) }}</h4>
                            <input type="number" class="form-control hide" value="{{ $model->money }}" readonly>
                        </div>
                    </div>
                    ...
                    @if($model->payment_type == \App\Models\Payment::TYPE_USDT)
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <h5 class="text-gray" style="background: #eee;">{{ number_format($usdtRate) }}</h5>
                                <input type="number" class="form-control hide" value="{{ $usdtRate }}"
                                       readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <h5 class="text-gray" style="background: #eee;">{{ number_format($model->money * $usdtRate) }}</h5>
                                <input type="number" class="form-control hide" value="{{ $model->money * $usdtRate }}"
                                       readonly>
                            </div>
                        </div>
                    @endif
