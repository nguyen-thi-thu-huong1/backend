        ...
        <div class="card">
            <div class="card-toolbar clearfix">
                <div class="toolbar-btn-action">
                    <a class="btn btn-primary m-r-5" href="{{ route("admin.publishers.create") }}"><i
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            @include('layouts._table_header',['data' => \App\Models\Publisher::$list_field,'model' => 'publisher'])
                        ...
                        @foreach ($data as $item)
                            <tr>
                                ...
                                @include('layouts._table_body',['data' => \App\Models\Publisher::$list_field,'item' => $item])

                                <td>{{ $item->created_at }}</td>
                                <td>
                                    <div class="btn-group">
                                        <a class="btn btn-xs btn-default"
                                           href="{{ route('admin.publishers.edit',['publisher' => $item->id]) }}" title=""
                                        ...
                                        <a class="btn btn-xs btn-default" href="javascript:;" data-operate="show-page"
                                           ...
                                           data-url="{{ route('admin.publishers.show', ['publisher' => $item->id]) }}">
                                            <i class="mdi mdi-file-document-box"></i>
                                        </a>

                                        @if($item->game_type == 3 || $item->game_type == 6 || \Illuminate\Support\Str::contains($item->publisher,'TCG'))
                                            <a class="btn btn-xs btn-default"
                                               href="javascript:;" data-operate="simple-deal"
                                               data-url="{{ route('admin.api.pull',['api_code' => $item->api_name]) }}"
                                               data-toggle="tooltip" data-original-title="@lang('res.publisher.index.btn_update')">
                                        ...
                                        <a class="btn btn-xs btn-default" href="javascript:;" data-operate="delete"
                                           ...
                                           data-url="{{ route('admin.publishers.destroy', ['publisher' => $item->id]) }}">
