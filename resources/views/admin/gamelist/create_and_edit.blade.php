        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="post" class="form-horizontal"
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">@lang('res.game_list.field.publisher')</label>
                        <div class="col-sm-4">
                            <select name="publisher_id" class="form-control js_select2">
                                <option value="">@lang('res.common.select_default')</option>
                                @foreach(\App\Models\Publisher::getPublisherNameArray() as $key => $value)
                                    <option value="{{ $key }}" @if($isUpdated && $model->publisher_id == $key) selected @endif>{{ $value }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
