        ...
        <div class="card">
            ...
            <div class="card-body">
                <ul id="myTabs" class="nav nav-tabs" role="tablist">
                    ...
                    <li>
                        <a href="#sbo_acount" id="sbo_acount-tab" role="tab" data-toggle="tab">@lang('res.system_config.config_groups.sbo_acount')</a>
                    </li>
                </ul>
                ...
                <div id="myTabContent" class="tab-content">
                    ...
                    <div class="tab-pane fade" id="sbo_acount">
                        @include('layouts._system_config_field', ['group_name' => 'sbo_acount'])
                    </div>
                </div>
            </div>
        </div>
