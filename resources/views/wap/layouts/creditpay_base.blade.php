...
<head>
    ...
    <link href="{{ public_url('/web/css/credit') }}/wapreset.css" rel="stylesheet">
    <link href="{{ public_url('/web/css/credit') }}/wapstyle.css" rel="stylesheet">
    <script src="{{ public_url('/web/js') }}/new_file.js" type="text/javascript" charset="utf-8"></script>
</head>
<body>
<div class="top">
