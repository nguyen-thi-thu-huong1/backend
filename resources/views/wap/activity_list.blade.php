...
<head>
    ...
    <script src="{{ public_url('/web/js/respond.min.js') }}" type="text/javascript"></script>
    ...
    <link href="{{ public_url('/web/css/activity/wapreset.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ public_url('/web/css/activity_iconfont.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ public_url('/web/css/activity/wapstyle.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ public_url('/web/css/activity/wapstyle9170.css') }}" rel="stylesheet" type="text/css">
