@if($member)
    ...
    <div class="btn-group">
        ...
        <ul class="dropdown-menu progress-bar-info">
            ...
            <li><a href="javascript:;" data-operate="show-page" data-title="@lang('res.option.statements') - 【{{ $member->name }}】"
                   data-url="{{ route('admin.statements.index',['member_id' => $member->id]) }}">@lang('res.option.statements')</a></li>
    ...
    <div>
        <span>
            Giới tính: {{$member->gender == 0 ? 'Nam' : 'Nữ'}}
        </span>
        ,
        <span>
            Vip: {{$member->level}}
