...
<head>
    ...
    <link rel="stylesheet" href="{{ public_url('/js/bootstrap-multitabs/multitabs.min.css') }}">
</head>
...
{{-- <script src="{{ public_url('/js/base-src/jquery.min.js') }}"></script>
<script src="{{ public_url('/js/base-src/bootstrap.min.js') }}"></script>
--}}

<script src="{{ public_url('/js/perfect-scrollbar.min.js') }}"></script>
...
<script src="{{ public_url('/js/bootstrap-multitabs/multitabs.js') }}"></script>
<script>
    window.layer = layer;
</script>
</body>
