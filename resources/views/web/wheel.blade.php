...
<head>
    ...
    <link href="{{ public_url('/web/css/wheel/style.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ public_url('/web/css/wheel/animate.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ public_url('/web/css/wheel/bootstrap.min.css') }}" rel="stylesheet" type="text/css">
...
<body style="min-width: 1100px;">
    ...
    <script src="{{ public_url('/web') }}/js/jquery-3.3.1.slim.min.js"></script>
    <script src="{{ public_url('/web') }}/js/popper.min.js"></script>
    <script src="{{ public_url('/web') }}/js/bootstrap.min.js"></script>
