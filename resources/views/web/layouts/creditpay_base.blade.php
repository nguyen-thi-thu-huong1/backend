...
<head>
    ...
    <link href="{{ public_url('/web/css/credit') }}/reset.css" rel="stylesheet">
    <link href="{{ public_url('/web/css/credit') }}/style.css" rel="stylesheet" type="text/css" />
</head>
<body>
...
<script src="{{ public_url('/web/js') }}/layer.js"></script>
<script src="{{ public_url('/web/js/credit') }}/page.js"></script>
<script src="{{ public_url('/web/js/credit') }}/page2.js"></script>

<link rel="stylesheet" href="{{ public_url('/web/css/credit') }}/limarquee.css">
<script src="{{ public_url('/web/js') }}/jquery.limarquee.js"></script>
<script>
    $.ajaxSetup({
        headers: {
