...
<head>
    ...
    <link href="{{ public_url('/web/css/activity/jbootstrappage.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ public_url('/web/css/activity/reset.css') }}" rel="stylesheet" type="text/css">
    {{-- <link href="{{ public_url('/web/css/activity/main.css') }}" rel="stylesheet" type="text/css"> --}}
    <link href="{{ public_url('/web/css/activity/captcha.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ public_url('/web/css/activity/base.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ public_url('/web/css/activity/base9170.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ public_url('/web/css/activity/animate.css') }}" rel="stylesheet" type="text/css">
    <script src="{{ public_url('/web/js/jquery-1.8.3.min.js') }}" type="text/javascript"></script>
    <script src="{{ public_url('/web/js/jq_scroll.js') }}" type="text/javascript"></script>
    <script src="{{ public_url('/web/js/jbootstrappage.js') }}" type="text/javascript"></script>
    <script src="{{ public_url('/web/js/clicaptcha.js') }}"></script>
