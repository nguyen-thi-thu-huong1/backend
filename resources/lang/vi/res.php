...
return [
    'common' => [
        ...
        'agent_id' => 'ID đại lý',
        'top_id' => 'ID cấp trên',
        'sbo_fs_type' => 'Hoàn trả SBO',
        'game_type' => 'Loại trò chơi',
        'product_type' => 'Loại trò chơi SBO',
        'deleted' => 'Đã xóa',
    ...
    'index' => [
        ...
        'today_bet' => 'Tổng tiền cược hôm nay',
        'today_game_profit' => 'Tổng doanh thu hôm nay',
        'month_register' => 'Số người đăng ký tháng này',
        'month_free' => 'Chi phí tiếp thị tháng này',
        'month_bet' => 'Tổng tiền cược tháng này',
        'month_game_profit' => 'Tổng doanh thu tháng này',
        '10_days_recharge' => 'Tổng tiền nạp 10 ngày qua',
        '10_days_drawing' => 'Tổng tiền rút 10 ngày qua',
        'welcome' => 'Chào mừng bạn, ',
        'recharge_title' => 'Nạp tiền',
        'drawing_title' => 'Rút tiền',
        'win_lose' => 'Báo cáo thắng/thua 30 ngày qua',

        'member_total' => 'Tổng thành viên',
        'online_member' => 'Thành viên trực tuyến',
        'member_login_today' => 'Thành viên đăng nhập hôm nay',
        'money_deposit_today' => 'Tổng số tiền nạp trong ngày',
        'money_withdraw_today' => 'Tổng số rút tiền trong ngày',
        'money_total_today' => 'Tổng số giao dịch trong ngày',
        'money_total_unprocessed_today' => 'Tổng số tiền nạp chưa xử lý trong ngày',
        'money_total_unprocessed_withdraw_today' => 'Tổng số tiền rút chưa xử lý trong ngày',
        'promotion_total_today' => 'Tổng khuyến mãi trong ngày',
        'daily_total_return_today' => 'Tổng hoàn trả trong ngày',
    ...
    'member' => [
        'field' => [
            ...
            "is_payment" => "Tình trạng nạp tiền",
            "lang" => "Ngôn ngữ",
...
Phân phối các đại lý',
        ...
        'money_report' => [
            ...
            'profit_formula' => 'Nạp tiền - rút tiền = lợi tức thực tế',
            'profit_financial' => 'Nạp tiền - rút tiền = Tổng số lợi nhuận và thô lỗ ',
            'yinli' => 'Lợi nhuận：',
            'kuisun' => 'Lôi kéo：'
        ],
    ...
    'apis' => [
        ...
        'index' => [
            ...
            'old_api_title' => 'Cài đặt cấu hình API cũ',
            'sbo_api_title' => 'Cài đặt cấu hình API SBO',
            ...
            'enable_sbo_log' => 'Bật log cho API',
            'agent_min_bet_setting' => 'Cài đặt lệnh cược nhỏ nhất',
            'agent_max_bet_setting' => 'Cài đặt lệnh cược lớn nhất (tối đa 1,000,000).',
            'agent_max_per_match' => 'Cài đặt lệnh cược lớn nhất trong 1 game (tối đa 1,000,000).',
            'user_min_bet_setting' => 'Cài đặt lệnh cược nhỏ nhất',
            'user_max_bet_setting' => 'Cài đặt lệnh cược lớn nhất (tối đa 1,000,000).',
            'user_max_per_match' => 'Cài đặt lệnh cược lớn nhất trong 1 game (tối đa 1,000,000).',
            'casino_table_limit' => 'Giới hạn sòng bạc (1: Thấp, 2: Trung bình, 3: Cao, and 4: VIP(Tất cả))',
            'btn_refresh' => 'Làm mới số dư giao diện',
            'config_title' => 'Cấu hình cơ bản của trang web',
            'sub_account' => 'Cấu hình tên tên khoản SBO',
        ],
    ...
    'eeziepay_histories' => [
        'field' => [
            "id" => "ID",
            "member_id" => "Tên người chơi",
            "billno" => "Số hóa đơn",
            "partner_orderid" => "Mã giao dịch",
            "bank_code" => "Ngân hàng",
            "currency" => "Tiền tệ",
            "request_amount" => "Số tiền nạp",
            "receive_amount" => "Tiền nhận được",
            "fee" => "Phí",
            "status" => "Trạng thái",
    ...
    'api_game' => [
        ...
        'category' => [
            'web_category_title' => 'Quản lý danh mục trò chơi trên pc',
            'mobile_category_title' => 'Quản lý danh mục trò chơi trên mobile',
            'game_category_name' => 'Tên danh mục',
            'game_category_route' => 'Điều hướng',
    ...
    'transaction_history' => [
        'field' => [
            "member_id" => "Người chơi",
            "product_type" => "Danh mục trò chơi",
            "game_type" => "Loại trò chơi",
            "game_id" => "Tên trò chơi",
            "game_provider" => "Nhà cung cấp",
            "game_round_id" => "game_round_id",
            "game_period_id" => "game_period_id",
            "transfer_code" => "Mã cá cược",
            "transaction_id" => "ID cá cược",
            "amount" => "Tiền cược",
            "win_loss" => "Thắng thua",
            "balance_before" => "Số dư trước",
            "balance_after" => "Số dư sau",
            "balance_histories" => "Lịch sử số dư",
            "transaction_time" => "Thời gian cá cược",
            "return_stake_time" => "Thời gian hoàn trả cá cược",
            "result_time" => "Thời gian nhận kết quả",
            "cancel_time" => "Thời gian hủy cá cược",
            "rollback_time" => "Thời gian hoàn tiền cá cược",
            ...
            "game" => "Trò chơi",
            "fs_detail" => "Hoàn trả",
            'pull_report_wager_id' => 'Báo cáo kéo cược',
        ],
    ],
    ...
    'system_config' => [
        'config_groups' => [
            ...
            'line' => 'Line',
            'site' => 'Tên trang web',
            'recharge' => 'Cài đặt nạp tiền',
            'drawing' => 'Cài đặt rút tiền',
            'register' => 'Đăng ký',
            'agent' => 'Đại lý',
            'notice' => 'Thông báo',
    ...
    'payment' => [
        ...
        "edit" => [
            ...
            "notice_arrange" => "Số thứ tự sắp xếp các ngân hàng.",
            "notice_callback_url" => "URL api call back (apinganhang.com)",
        ],
    ...
    'recharge' => [
        'field' => [
            ...
            "before_money" => "Số tiền trước khi nạp",
            "after_money" => "Số tiền sau khi nạp",
            "score" => "Điểm",
            "fail_reason" => "Nguyên nhân thất bại",
            "hk_at" => "Thời gian chuyển tiền của khách hàng",
            "confirm_at" => "Thời gian xác nhận chuyển tiền",
            "status" => "Trạng thái",
        ...
        'index' => [
            'btn_confirm' => "Xác nhận nạp tiền",
            'btn_reject' => "Hủy lệnh nạp",
            'btn_payment_detail' => "Chi tiết tài khoản nạp tiền"
        ],
    ...
    'drawing' => [
        ...
        'index' => [
            'btn_confirm' => 'Xác nhận rút tiền',
            'btn_reject' => 'Hủy lệnh rút'
        ],
    ...
    'member_money_log' => [
        ...
        'notice' => [
            ...
            'get_fs_now' => 'Ngày nhận【 :time 】，Số tiền nhận được【 :money 】，Trò chơi【 :game_type】，Gửi về ví hoàn trả',
    ...
    'option' => [
        ...
        'payment_type' => [
            ...
            'online_eeziepay' => 'Thanh toán Eeziepay (Thanh toán trực tuyến)',
            ...
            'online_cardpay' => 'Thanh toán qua thẻ cào',
            'online_momo' => 'Thanh toán ví điện tử Momo(Ví điện tử)',
            'online_zalopay' => 'Thanh toán ví điện tử Zalopay (Ví điện tử)',
            'online_viettelpay' => 'Thanh toán ví điện tử Viettelpay (Ví điện tử)',
        ],
        ...
        'fs_type' => [
            1 => 'Hoàn trả hệ thống',
            2 => 'Cấp độ của thành viên',
            44 => 'Hoàn trả SABA Sport',
            1015 => 'Hoàn trả AFB Sport',
            1022 => 'Hoàn trả BTI Sport',
        ],
    ...
    'configs' => [
        ...
        "7_days_calculate_reward" => "7 Ngày tính thưởng (Nếu không chọn sẽ tính thưởng theo tháng)",
        ...
        "transfer_end" => "Thời gian không thể rút tiền",
        ...
        "vip1_is_register_sms_open" => "Có bật xác minh SMS lấy mật khẩu hay không",
        "service_line" => "Line",
        ...
        "zalo" => "Zalo",
        "facebook" => "Facebook",
        "game_histories_schedule" => "Lấy lịch sử cược API cũ (Phút)",
        "resend_transaction_schedule" => "Lấy kết quả cược chưa trả thưởng (Phút)",
        "transaction_histories_keep_day" => "Lưu trữ lịch sử cược (ngày)",
    ],
    ...
    'publisher' => [
        'field' => [
            "title" => "Tiêu đề nhà cung cấp",
            "subtitle" => "Phụ đề",
            "web_pic" => "Hình ảnh phía máy tính",
            "mobile_pic" => "Hình ảnh điện thoại di động",
            "api_name" => "Nhận dạng giao diện",
            "class_name" => "Nhận diện kiểu dáng",
            "game_type" => "Các loại nhà cung cấp",
            "params" => "Các thông số",
            "client_type" => "Nền tảng điều hành",
            "is_open" => "Bật/Tắt",
            "weight" => "Thứ tự",
        ...
        'index' => [
            'top_notice' => 'Nhà cung cấp hiển thị văn bản Trong những sửa đổi như vậy',
            'btn_update' => 'Cập nhật nhà cung cấp',
            'web_pic_notice' => '【Điện tử】Hình ảnh đã phân loại tương ứng với danh sách nhà cung cấp Logo'
        ],

        'category' => [
            'web_category_title' => 'Quản lý danh mục nhà cung cấp trên pc',
            'mobile_category_title' => 'Quản lý danh mục nhà cung cấp trên mobile',
            'game_category_name' => 'Tên danh mục',
            'game_category_route' => 'Điều hướng',
            'image_preview' => 'Hình ảnh',
            'status' => 'Trạng thái',
    ...
    '亚太地区 亚太地区' => 'Châu Á Thái Bình Dương',
    '中国 台湾 台北市  710100' => 'Trung Quốc Đài Loan Đài Bắc',
    '中国 香港   810000' => 'Hồng Kông, Trung Quốc',
    '中国 香港' => 'Hồng Kông, Trung Quốc',
    '法国 法国' => 'Nước Pháp',
    '美国 美国' => 'Hoa Kỳ',
    '荷兰 荷兰' => 'Hà Lan',
    '越南 越南' => 'Việt Nam',
    ...
    '新加坡 新加坡' => 'Singapore',
    '日本 日本' => 'Nhật Bản',
    '本机地址 本机地址' => 'Địa chỉ địa phương',
    '柬埔寨 柬埔寨' => 'Campuchia',
    '欧洲地区 欧洲地区' => 'Khu vực Châu Âu',
    '菲律宾 菲律宾' => 'Philippines',
    '韩国 韩国' => 'Hàn Quốc',
    '澳大利亚 澳大利亚' => 'Úc',
    '英国 英国' => 'Anh',
    '印度尼西亚 印度尼西亚' => 'Indonesia',
    '中国 台湾 710000' => 'Đài Loan, Trung Quốc',
    '罗马尼亚 罗马尼亚' => 'Romania',
    '丹麦 丹麦' => 'Đan Mạch',
    '中国 台湾 台北市  710100' => 'Taiwan, China',
    '中国 台湾   710000' => 'Taiwan, China'
];
